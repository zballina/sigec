...
class reporte_rubricas extends reporte_base
{
    public function __construct($id)
    {
        ...
        $this->nombreDocumento = 'CONCENTRADO DE RÚBRICAS DE EVALUACIÓN';
        $this->prefijoArchivo = 'Rúbricas-';
    ...
    protected function reporte()
    {
        ...
        foreach ($rs as $section) 
        {
            if($section->section > 0)
            {
                ...
                $html .= $section->section == 1 ? "<h1>Unidad $section->section</h1>"
                        :"<h1 style='page-break-before:always;'>Unidad $section->section</h1>";
                $html .=
                '<table>
                    <thead>
                        <tr>
