...
//            $grupo_alumno[] = $mform->createElement('static', "firstname$alumno->id");
//            $grupo_alumno[] = $mform->createElement('select', "asistio$alumno->id", get_string('alumno_asistio', 'sesionclase'), array(ASISTENCIA_ALUMNO_ASISTIO));
...
//            $grupo_alumno[] = $mform->createElement('text', "observaciones$alumno->id", get_string('observaciones', 'sesionclase'), null);
            $mform->addGroup($grupo_alumno, "alumno$alumno->id", "$alumno->username", array(' '), false);
//            $mform->addElement('text', "observaciones$alumno->id", get_string('observaciones', 'sesionclase'), null);
...
//            $mform->setType("firstname$alumno->id", PARAM_TEXT);
//            $mform->setType("observaciones$alumno->id", PARAM_TEXT);
            $cuenta++;
        }
...
//            $firstname = "firstname$usuario->id";
//            $default_values->$firstname = $usuario->firstname;
//            $observaciones = "observaciones$usuario->id";
//            $default_values->$observaciones = $usuario->observaciones;
