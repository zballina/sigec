...
/**
 * Strings for component 'quiz_grading', language 'es_mx', branch 'MOODLE_25_STABLE'
 *
...
$string['alreadygraded'] = 'Ya fue calificado';
$string['alsoshowautomaticallygraded'] = 'Mostrar también preguntas que han sido calificadas automáticamente';
$string['attemptstograde'] = 'Intentos para calificar';
$string['automaticallygraded'] = 'Calificados automáticamente';
$string['backtothelistofquestions'] = 'Volver a la lista de preguntas';
$string['bydate'] = 'Por fecha';
$string['bystudentidnumber'] = 'Por número ID del estudiante';
$string['bystudentname'] = 'Por nombre del estudiante';
...
$string['gradeattemptsall'] = 'Todos los ({$a})';
$string['gradeattemptsautograded'] = 'Los que han sido automáticamente calificados ({$a})';
$string['gradeattemptsmanuallygraded'] = 'Los que han sido  calificados manualmente con anterioridad ({$a})';
$string['gradeattemptsneedsgrading'] = 'Los que necesitan calificarse  ({$a})';
...
$string['gradingquestionx'] = 'Calificando las preguntas {$a->number}: {$a->questionname}';
...
$string['grading:viewidnumber'] = 'Ver los numerosID de los estudiantes mientras califica';
$string['grading:viewstudentnames'] = 'Ver los nombres de los estudiantes mientras califica';
$string['hideautomaticallygraded'] = 'Ocultar preguntas que fueron calificadas de forma automática';
...
$string['noquestionsfound'] = 'No se encontraron preguntas para calificar manualmente';
