...
/**
 * Strings for component 'webservice', language 'es_mx', branch 'MOODLE_25_STABLE'
 *
 * @package   webservice
...
$string['missingusername'] = 'Falta nombredeusuario';
...
$string['usernameorid'] = 'Nombredeusuario / ID de Usuario';
$string['usernameorid_help'] = 'Introduzca el nombredeusuario o la ID de usuario.';
$string['usernameoridnousererror'] = 'No se encontraron usuarios con este nombredeusuario / ID de usuario';
$string['usernameoridoccurenceerror'] = 'Se encontró a más de un usuario con este nombredeusuario. Por favor introduzca la ID del usuario';
...
$string['wrongusernamepassword'] = 'Nombredeusuario o contraseña erróneos';
$string['wsaccessuserdeleted'] = 'Se rechazó el acceso a servicio web para el nombredeusuario eliminado: {$a}';
$string['wsaccessuserexpired'] = 'Se rechazó el acceso a servicio web para el nombredeusuario con contraseña caduca: {$a}';
$string['wsaccessusernologin'] = 'Se rechazó el acceso a servicio web para el nombredeusuario con autenticación sin-ingreso (nologin): {$a}';
$string['wsaccessusersuspended'] = 'Se rechazó el acceso a servicio web para el nombredeusuario suspendido: {$a}';
$string['wsaccessuserunconfirmed'] = 'Se rechazó el acceso a servicio web para el nombredeusuario no-confirmado: {$a}';
...
$string['wsdocumentationlogin'] = 'o escriba su nombredeusuario y la contraseña de servicios web:';
$string['wspassword'] = 'Contraseña del Servicio Web';
$string['wsusername'] = 'Nombredeusuario del Servicio Web';
