...
/**
 * Strings for component 'local_moodleorg', language 'es_mx', branch 'MOODLE_23_STABLE'
 *
...
$string['aboutdemosite'] = 'Nuestro sitio de demostración es un sitio Moodle con todas sus características y algunos cursos de ejemplo donde puede acceder como profesor, estudiante o incluso como administrador. No se preocupe por estropear algo, el sitio completo se vacía y reinicia cada hora.';
...
$string['aboutstatistics'] = 'Moodle se puede descargar libremente y su registro es voluntario, de manera que no disponemos la información completa de quién lo está utilizando. De todas formas, con la información de que disponemos, generamos automáticamente algunas gráficas y datos numéricos en nuestra página de Estadísticas.';
...
$string['browsecvstitle'] = 'Vea nuestro código fuente';
...
$string['connectedsites'] = 'Algunos sitios Moodle han sido conectados con moodle.org usando la Red Moodle (Moodle Networking), de manera que puede acceder a dichos sitios directamente una vez que se ha autenticado aquí.';
...
$string['developers'] = 'El desarrollo principal de Moodle es lidereado por el equipo de Moodle.com y ayudado por cientos de desarrolladores en todo el mundo.  Muchos de esos desarrolladores son también responsables directos de diferentes módulos y extensiones.';
...
$string['donationsmoney'] = 'Puede contribuir con dinero directamente al fondo a través de una donación en efectivo. Todo este dinero se utiliza para convertir en realidad  los deseos de nuestro plan de desarrollo y que todos podamos disfrutarlos. Para hacer una donación con tarjeta de crédito en la mayoría de las principales monedas, por favor haga clic en el botón inferior de Paypal. <br /> <br /> Los donantes de más de $10 (dólares) añadirán su nombre a esta página durante un año. Por favor, recuerde pulsar el botón "Continuar" después de pagar para ver el formato donde podrá editar la manera en que aparecerá su donativo.';
...
$string['downloadcvs'] = 'Otra forma de obtener el código fuente del núcleo es utilizar directamente CVS para conectar directamente con alguno de los servidores que utilizan los desarrolladores de Moodle. Esto facilita el proceso de actualización, incluso si ha hecho cambios locales en el código fuente de su sitio Moodle.';
...
$string['downloadmodulestitle'] = 'Módulos y plugins';
...
$string['moodlecertification'] = 'Certificación en Moodle';
$string['moodleconsulting'] = 'Consultoría en Moodle';
...
$string['moodlehosting'] = 'Alojamiento (hosting) de Moodle';
$string['moodleinstallation'] = 'Instalación de Moodle';
$string['moodleintegrations'] = 'Integraciones con Moodle';
$string['moodlesupport'] = 'Soporte para Moodle';
$string['moodlethemes'] = 'Temas gráficos de Moodle';
$string['moodletrackertitle'] = 'Rastreador (tracker)de Moodle';
$string['moodletraining'] = 'Capacitación en Moodle';
...
$string['newregistrations'] = 'Los sitios Moodle que figuran a continuación han sido conectados con moodle.org utilizando la Red Moodle, de manera que puede entrar a ellos directamente desde aquí.';
$string['newsbuzz'] = 'Chismes sobre Moodle';
$string['newsbuzzdetail'] = 'Publicaciones relacionadas con Moodle de todo el mundo';
$string['newscalendar'] = 'Calendario';
$string['newscalendardetail'] = 'Eventos futuros relacionados con Moodle';
...
$string['newsrecent'] = 'Aggregated';
$string['newssecurity'] = 'Avisos de seguridad';
$string['newssecuritydetail'] = 'Información importante sobre asuntos de seguridad';
...
$string['overviewdevelopment'] = 'Una descripción general sobre el desarrollo de Moodle';
$string['overviewdownloads'] = 'Una vista general de las descargas de Moodle';
$string['overviewmy'] = 'Ver todos los cursos de moodle.org donde Usted está inscrito';
$string['overviewnews'] = 'Una vista general de las noticias de Moodle';
$string['overviewsupport'] = 'Una vista general de las noticias de Moodle';
...
$string['registrationgraphalt'] = 'Registros totales de Moodle a lo largo del tiempo';
...
$string['roadmap'] = 'Plan de desarrollo de Moodle';
$string['shop'] = '¿Busca la forma de hacer notar que forma parte de nuestra comunidad? Eche un ojo a nuestra tienda donde encontrará camisetas, tazas y otras cosas.';
