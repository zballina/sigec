...
/**
 * Strings for component 'repository', language 'es_mx', branch 'MOODLE_25_STABLE'
 *
 * @package   repository
...
$string['confirmremove'] = '¿Está seguro de que desea eliminar este plugin de repositorio, sus opciones y <strong>todas sus instancias</strong> - {$a}? Si Usted elige "Continuar y descargar", referencias de archivos hacia contenidos externos serán descargados a Moodle, pero esto podría tomar mucho tiempo para ser procesado.';
...
$string['errorpostmaxsize'] = 'El tamaño del archivo a subir excede la directriz post_max_size en php.ini.';
...
$string['newfoldername'] = 'Nuevo nombre de carpeta:';
