...
/**
 * Strings for component 'message', language 'es_mx', branch 'MOODLE_25_STABLE'
 *
 * @package   message
...
$string['addsomecontacts'] = 'Para mandarle un mensaje a alguien, o para añadirles un atajo en esta página, use <a href="{$a}">search tab</a> arriba.';
...
$string['contactlistempty'] = 'La lista de contactos está vacía';
...
$string['disableall'] = 'Deshabilitar notificaciones temporalmente';
$string['disableall_help'] = 'Desabilitar todas las notificaciones temporalmente excepto aquellas marcadas como "forzadas" por el administrador del sitio';
...
$string['managemessageoutputs'] = 'Administrar salidas de mensajes';
...
$string['messagenavigation'] = 'Navegación mensaje:';
$string['messageoutputs'] = 'Salidas de Mensajes';
