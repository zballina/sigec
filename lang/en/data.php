...
$string['availabletags_help'] = '<p align="center"><strong>Marcas disponibles</strong></p> <p>Las marcas (\'tags\') son remplazables (\'placeholders\') en la plantilla que se sustituyen con datos o con otras características (como un ícono de edición) cuando se editan o se muestran las entradas.</p> <p>Los campos tienen el siguiente formato: [[fieldname]]</p> <p>Todas las otras marcas (tags) tienen el formato: ##somebutton##</p> <p>En la plantilla actual sólo pueden usarse las marcas que están en la lista de "Marcas disponibles".</p>';
...
$string['cannotoverwritepreset'] = 'Error al sobre-escribir pre-seleccionado';
...
$string['data:viewallratings'] = 'Ver todas las valuaciones (ratings) emitidas por los usuarios';
$string['data:viewalluserpresets'] = 'Ver ajustes previos de todos los usuarios';
$string['data:viewanyrating'] = 'Ver el total de valuaciones (ratings) que alguien recibió';
...
$string['directorynotapreset'] = '{$a->directory} No es default: archivos faltantes: {$a->missing_files}';
...
$string['emptyadd'] = 'La plantilla Agregar está vacía, generando un formato por defecto...';
...
$string['exportaszip_help'] = 'Exportar como archivo Zip permite descargar las plantillas a su computadora. Podrá subirlas más tarde a otra base de datos usando la opción Importar de archivo Zip.';
...
$string['fieldwidthsingleview'] = 'Ancho en vista única';
$string['file'] = 'Archivo';
...
$string['headersingletemplate'] = 'Define interfase del navegador para entrada única';
$string['importentries'] = 'Importar entradas';
$string['importsuccess'] = 'El ajuste previo ha sido aplicado con éxito.';
$string['includeapproval'] = 'Incluir status de aprobación';
...
$string['nosingletemplate'] = 'La plantilla única no ha sido definida';
