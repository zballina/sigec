...
/**
 * Strings for component 'workshop', language 'es_mx', branch 'MOODLE_25_STABLE'
 *
 * @package   workshop
...
$string['areaoverallfeedbackattachment'] = 'Anexos de retroalimentación total';
$string['areaoverallfeedbackcontent'] = 'Textos de retroalimentación total';
...
$string['latesubmissions_help'] = 'Si está activada esta opción, un autor puede enviar su trabajo fuera de plazo o durante la fase de evaluación. Sin embargo, los envíos extemporáneos no se pueden editar.';
...
$string['nullgrade'] = '-';
$string['overallfeedback'] = 'Retroalimentación total';
$string['overallfeedbackfiles'] = 'Número máximo de anexos de retrolimentación total';
$string['overallfeedbackmaxbytes'] = 'Tamaño máximo del anexo a la retroalimentación global';
$string['overallfeedbackmode'] = 'Modo de retroalimentación total';
...
$string['overallfeedbackmode_help'] = 'Si se habilita, se muestra un campo de texto al final del formato de evaluación. Los revisores pueden poner la evaluación total del envío allí, o proporcionar explicaciones adicionales acerca de su evaluación.';
...
$string['switchphase10info'] = 'Está a punto de cambiar el taller a la <strong>Fase de configuración </strong>. En esta fase, los usuarios no pueden modificar su envío o sus evaluaciones. Los profesores pueden usar esta fase para cambiar las configuraciones del taller, modificar la estrategia de calificación o alterar los formatos de evaluación.';
...
$string['workshop:editdimensions'] = 'Editar formato de evaluación';
