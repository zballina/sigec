...
/**
 * Strings for component 'tracker', language 'es_mx', branch 'MOODLE_23_STABLE'
 *
 * @package   tracker
...
$string['modulename_help'] = 'La actividad de Rastreador (Tracker) permite rastrear boletos (tickets) para ayuda, reporte de fallas (bugs) o también actividades rastreables en un curso.
