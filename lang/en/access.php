...
/**
 * Strings for component 'access', language 'es_mx', branch 'MOODLE_25_STABLE'
 *
 * @package   access
...
$string['accesshelp'] = 'Ayuda accesibilidad';
$string['accesskey'] = 'Clave de acceso, {$a}';
$string['accessstatement'] = 'Declaración de accesabilidad';
$string['activitynext'] = 'Siguiente actividad';
$string['activityprev'] = 'Actividad previa';
$string['breadcrumb'] = 'Camino navegado (breadcrumbs)';
