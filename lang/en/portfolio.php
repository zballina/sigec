...
/**
 * Strings for component 'portfolio', language 'es_mx', branch 'MOODLE_25_STABLE'
 *
 * @package   portfolio
...
$string['exportexpireddesc'] = 'Trató de repetir la exportación de alguna información, o empezar una exportación vacía. Para hacer esto correctamente, debe regresar a la localización original y empezar de nuevo.Esto a veces sucede cuando usa el botón de regresar después de completar una exportación o al poner un marcador en una URL inválida.';
...
$string['leap2a_overwritingselection'] = 'Sobre-escribiendo el tipo original de una entrada ({$a}) a la selección en make_selection';
...
$string['mustsetcallbackoptions'] = 'Usted debe configurar las opciones de callback en el constructor portfolio_add_button o emplear el método de set_callback_options';
...
$string['plugincouldnotpackage'] = 'Falló el empaquetamiento de sus datos para exportar: el error original era {$a}';
