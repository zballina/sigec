...
/**
 * Strings for component 'quiz', language 'es_mx', branch 'MOODLE_25_STABLE'
 *
 * @package   quiz
...
$string['accessnoticesheader'] = 'Puede previsualizar este examen, pero si éste fuera un intento real, podría ser bloqueado debido a:';
...
$string['addarandomquestion_help'] = 'Cuando se añade una pregunta al azar, se traduce en que en el examen se inserta una pregunta seleccionada aleatoriamente de entre las que componen la categoría. Esto significa que los distintos alumnos tendrán probablemente una selección distinta de preguntas. Por otra parte, cuando el examen permite múltiples intentos, cada uno de ellos probablemente contendrá una nueva selección de preguntas.';
$string['adddescriptionlabel'] = 'Agregar descripción/etiqueta';
$string['addingquestion'] = 'Agregando una pregunta';
$string['addingquestions'] = 'Esta parte de la página es el lugar para administrar las preguntas. Las preguntas se agrupan en categorías para ayudarlo en la organización, pero pueden ser utilizadas por cualquier examen en su curso o en otro curso si usted decide \'publicarlas\'.<br />Después seleccionar o crear una categoría podrá crear o editar preguntas. Puede seleccionar cualquiera de esas preguntas para agregarlas al otro lado de la página.';
...
$string['autosaveperiod'] = 'Periodo de auto-guardar';
$string['autosaveperiod_desc'] = 'Las respuestas de los estudiantes pueden ser guardadas automáticamente cada ciertos minutos durante los intentos de contestar un examen. Ésto involucra una concertación/cesión: al guardar las respuestas se aumenta la carga del servidor, pero se reduce el riesgo de que los estudiantes pierdan su trabajo.';
...
$string['configoutcomesadvanced'] = 'Si esta opción se activa, entonces las Competencias (resultados) en el formato de edición del examen serán configuraciones avanzadas.';
...
$string['configreviewoptions'] = 'Estas opciones controlan qué información pueden ver los usuarios cuando revisan un intento de resolver el examen o cuando examinan los informes del examen.';
...
$string['configshufflequestions'] = 'Si habilita esta opción, el orden de preguntas se ordenará al azar cada vez que el estudiante intenta resolver el examen.';
...
$string['confirmstartattemptlimit'] = 'Se ha establecido un límite de {$a} intentos para resolver el examen. Está a punto de comenzar un nuevo intento. ¿Desea continuar?';
$string['confirmstartattempttimelimit'] = 'Este examen tiene un límite de tiempo y está restringido a {$a} intentos. El acceso al examen será contado como un intento. ¿Desea continuar?';
$string['confirmstarttimelimit'] = 'El examen tiene un límite de tiempo. ¿Está seguro de que desea comenzar?';
...
$string['emailconfirmbody'] = 'Hola, {$a->username}, Gracias por enviar sus respuestas al examen \'{$a->quizname}\' del curso \'{$a->coursename}\' en {$a->submissiontime}.

Este mensaje confirma que hemos recibido correctamente sus respuestas.

Puede acceder al examen en esta dirección: {$a->quizurl}.';
...
$string['emailnotifybody'] = 'Hola, {$a->username}, {$a->studentname} ha completado  \'{$a->quizname}\' ({$a->quizurl}) en el curso \'{$a->coursename}\'

Puede revisar esteintento en {$a->quizreviewurl}.';
...
$string['emailoverduebody'] = 'Estimado {$a->studentname}, Usted inició un intento de  \'{$a->quizname}\' en el curso \'{$a->coursename}\', pero nunca lo envío. Debió de haberse enviado antes de  {$a->attemptduedate}.

Si todavía quiere enviar este intento, vaya por favor a  {$a->attemptsummaryurl} y elija el botón \'enviar\'. Debe hacerlo antes de  {$a->attemptgraceend} o de lo contrario no se le contará el intento.';
...
$string['emailoverduesubject'] = 'Intentos retrasados actualmente: {$a->quizname}';
$string['empty'] = 'Vacío';
...
$string['graceperiod'] = 'Periodo de gracia para envío';
$string['graceperiod_desc'] = 'Si se configura que cuando se agote el tiempo a "hay un periodo de gracia para enviar el intento, pero no pueden contestarse más preguntas", la cantidad por defecto de tiempo extra que se permite, en segundos. 300 = 5 minutos; 86400 = 24 horas.';
$string['graceperiod_help'] = 'Si se configura que cuando se agote el tiempo a "hay un periodo de gracia para enviar el intento, pero no pueden contestarse más preguntas", la cantidad por defecto de tiempo extra que se permite.';
$string['graceperiodmin'] = 'Periodo de gracia para último envío';
$string['graceperiodmin_desc'] = 'Hay un problema potencial al final del examen. Por una parte, queremos que los estudiantes sigan trabajando justo hasta el último segundo - con la ayuda del cronómetro que automáticamente envía el examen cuando se agota el tiempo. Por la otra parte, en ese instante se puede sobrecargar el servidor, y necesitar más tiempo para procesar estas respuestas. Por lo tanto, aceptaremos respuestas por esta cantidad de segundos después de agotado el tiempo, de forma que no sean penalizados debido a que el servidor se alentó. Sin embargo, el estudiante podría hacer trampa y obtener estos segundos extra para contestar el examen. Usted debe balancear de acuerdo a qué tanto confía en el desempeño rápido de su servidor durante los exámenes.';
$string['graceperiodtoosmall'] = 'El periodo de gracia debe ser mayor de  {$a}.';
...
$string['inactiveoverridehelp'] = '* El estudiante no tiene el rol o el grupo correctos para intentar resolver el examen';
...
$string['messageprovider:submission'] = 'Notificación del envío del examen';
$string['min'] = 'Mín';
...
$string['modulename_help'] = 'El módulo <b>examen</b> le permite al profesor diseñar y plantear exámenes con preguntas tipo opción múltiple, falso/verdadero, relacionar columnas, respuesta corta y calculada.
...
$string['nogradewarning'] = 'Este examen no está calificado, por lo que no puede escribir una retroalimentación total en función de la calificación.';
...
$string['noview'] = 'Al usuario identificado no se le permite ver este examen.';
...
$string['orderandpaging_help'] = 'Los números 10, 20, 30, ... en el lado opuesto a las preguntas indican el orden de las preguntas. Los números aumentan en pasos de 10 en 10 para dejar espacio para insertar preguntas adicionales. Para re-ordenar las preguntas, cambie la numeración y después haga click en el botón de "Reordenar preguntas".
...
Para arreglar las preguntas de varias páginas, haga click en el botón de repaginar y elija el número deseado de preguntas por cada página.';
$string['orderingquiz'] = 'Orden y paginación';
$string['orderingquizx'] = 'Orden y paginación: {$a}';
$string['outcomesadvanced'] = 'Las competencias (resultados) son configuraciones avanzadas';
$string['outof'] = '{$a->grade} de un máximo de {$a->maxgrade}';
$string['outofpercent'] = '{$a->grade} de un máximo de {$a->maxgrade} ({$a->percent}%)';
$string['outofshort'] = '{$a->grade}/{$a->maxgrade}';
$string['overallfeedback'] = 'Retroalimentación total según calificación';
$string['overallfeedback_help'] = '<p>La retroalimentación total consiste en un texto que se muestra al estudiante una vez que ha completado un intento de resolver el examen. El texto puede depender de la calificación que el estudiante haya conseguido.</p> <p>Por ejemplo, si usted escribe "¡Buen trabajo!" en la primera caja de retroalimentación, escribe 40% en la primera caja de límites de la calificación y escribe "Por favor, vuelve a revisar el trabajo de esta semana", los estudiantes que puntúen 40% o más verán el mensaje "¡Buen trabajo!", en tanto que los que hayan puntuado menos del 40% verán el otro mensaje.</p> <p>Los límites de las calificaciones pueden especificarse en forma de porcentajes, por ejemplo "31.41%", o en forma de números, por ejemplo "7". Si el examen vale10 puntos, un límite de calificación de 7 significa 7/10 o superior.</p>';
$string['overdue'] = 'Vencido';
$string['overduehandling'] = 'Cuando se agote el tiempo';
$string['overduehandlingautoabandon'] = 'todo acabó. El intento debe enviarse antes de que se agote el tiempo, o no será contado';
...
$string['overduehandlinggraceperiod'] = 'hay un periodo de gracia para enviar los intentos abiertos, pero no pueden contestarse más preguntas';
$string['overduehandling_help'] = 'Esta configuración controla lo que sucede si los alumnos no envían su intento de examen antes de que se agote el tiempo. Si los estudiantes están trabajando activamente en el exámen en ese instante, entonces el cronómetro siempre enviará automáticamente el intento por ellos, pero si ellos se han salido del sitio, entonces esta configuración controla lo que sucederá.';
$string['overduemustbesubmittedby'] = 'Este intento actualmente está retrasado. Usted ya debería de haberlo enviado. Si Usted pretende que le califiquen este examen, debe de enviarlo a más tardar antes de {$a}.Si no lo envía para entonces, no se le contarán puntos de calificación para este intento.';
...
$string['quizclosed'] = 'Este examen se cierra el {$a}';
$string['quizcloses'] = 'Examen cerrado';
$string['quizcloseson'] = 'Este examen se cerrará el {$a}';
$string['quiz:deleteattempts'] = 'Eliminar intentos';
$string['quiz:emailconfirmsubmission'] = 'Confirmación por email al enviar';
$string['quiz:emailnotifysubmission'] = 'Recibir mensaje de notificación cuando se envía un intento';
$string['quiz:emailwarnoverdue'] = 'Recibir mensaje de notificación cuando un intento está retrasado y debe ser entregado.';
$string['quiz:grade'] = 'Calificar exámenes manualmente';
$string['quiz:ignoretimelimits'] = 'Pasa por alto el límite de tiempo en los exámenes';
...
$string['quizopenedon'] = 'Este examen está abierto en {$a}';
...
$string['quiz:viewreports'] = 'Ver informes de exámenes';
...
$string['reviewclosed'] = 'Después de cerrar el examen';
...
$string['reviewoptionsheading_help'] = 'Estas opciones controlan qué información pueden ver los alumnos cuando revisan un intento de resolver el examen o cuando consultan los informes correspondientes.

**Durante el intento** esta configuración solamente es relevante para algunos comportamientos como el \'interactivo con múltiples intentos\', en donde se muestra la retroalimentación durante el intento

</p> <p>**Immediatamente después del intento**: la revisión podrá hacerse en los dos minutos siguientes al final de un intento (tras haber pulsado el usuario \'Enviar todo y terminar\').</p> <p>**Más tarde, mientras el examen está aún abierto**: la revisión podrá hacerse en cualquier momento previo a la fecha de cierre.</p> <p>**Una vez que el examen está cerrado**: la revisión podrá realizarse una vez que haya pasado la fecha de cierre del examen. Obviamente, si el examen no tiene fecha de cierre, esta opción no es posible.</p>';
$string['reviewoverallfeedback'] = 'Retroalimentación total';
...
$string['saveattemptfailed'] = 'No se ha podido guardar el intento de resolver el examen.';
...
$string['showuserpicture_help'] = '<p> Si usted habilita esta opción, el nombre del estudiante y su imagen serán mostradas en la pantalla durante un intento, y en la pantalla de revisión.</p> <p> Un ejemplo en el que usted quisiera hacer esto es en exámenes obligatorios (vigilados en el aula) para hacer más sencillo el verificar la identidad del usuario que intenta el examen.</p>';
...
$string['statefinished'] = 'Terminado';
$string['statefinisheddetails'] = 'Envió {$a}';
...
$string['viewallanswers'] = 'Ver {$a} examenes resueltos';
...
$string['yourfinalgradeis'] = 'Su calificación final en este examen es {$a}.';
