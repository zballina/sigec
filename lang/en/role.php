...
/**
 * Strings for component 'role', language 'es_mx', branch 'MOODLE_25_STABLE'
 *
 * @package   role
...
$string['blog:associatecourse'] = 'Esta capacidad está deprecada y no hace nada.';
$string['blog:associatemodule'] = 'Esta capacidad está deprecada y no hace nada.';
...
$string['category:create'] = 'Crear carreras';
$string['category:delete'] = 'Eliminar carreras';
$string['category:manage'] = 'Gestionar carreras';
$string['category:update'] = 'Actualizar carreras';
$string['category:viewhiddencategories'] = 'Ver carreras ocultas';
$string['category:visibility'] = 'Ver carreras ocultas';
...
$string['course:changecategory'] = 'Cambiar la carrera del curso';
...
$string['course:viewsuspendedusers'] = 'Pueden verse usuarios suspendidos.';
...
$string['frontpageuserdescription'] = 'Todos los usuarios identificados en el curso de la portada';
...
$string['grade:manageoutcomes'] = 'Manejar competencias de calificación';
...
$string['legacytype'] = 'Tipo de rol antiguo heredado';
$string['legacy:user'] = 'ROL HEREDADO: Usuario autenticado';
...
$string['my:configsyspages'] = 'Configurar plantillas del sistema para las páginas de Mi Hogar';
$string['my:manageblocks'] = 'Gestionar bloques de página de Mi Hogar';
