...
/**
 * Strings for component 'tool_uploaduser', language 'es_mx', branch 'MOODLE_25_STABLE'
 *
...
$string['allowsuspends'] = 'Permitir suspender y activar cuantas';
...
$string['pluginname'] = 'Subida de usuarios';
...
$string['uploadpictures_help'] = 'Las imágenes de los usuarios se pueden cargar masivamente mediante un archivo zip. Estos archivos debe ser nombrados en atención al "atributo del usuario" elegido (username, idnumber, id) por ejemplo user1234.jpg para un usuario con nombredeusuario (username) user1234.
...
* Los nombres de campo necesarios son username, password, firstname, lastname, email (nombre-de-usuario, contraseña, nombre, apellidos, correo)';
...
$string['uuoptype_addinc'] = 'Agregar todo, añadir contador a nombresdeusuarios si fuera necesario.';
...
$string['uustandardusernames'] = 'Estandarizar nombresdeusuario';
$string['uuupdateall'] = 'Pasar por alto con archivo y valores por defecto';
$string['uuupdatefromfile'] = 'Pasar por alto con archivo';
$string['uuupdatemissing'] = 'Rellenar datos ausentes del archivo y valores por defecto';
$string['uuupdatetype'] = 'Detalles de usuario existente';
$string['uuusernametemplate'] = 'Plantilla de nombredeusuario';
