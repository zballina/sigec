...
/**
 * Strings for component 'tool_xmldb', language 'es_mx', branch 'MOODLE_25_STABLE'
 *
 * @package   tool_xmldb
...
$string['confirmcheckoraclesemantics'] = 'Esta funcionalidad buscará <a href="http://tracker.moodle.org/browse/MDL-29322">Oracle varchar2 columns usando semántica BYTE </a> en su servidor Moodle, generando, (¡pero no ejecutando!) automaticamente las instrucciones SQL necesarias para que todas las columnas se conviertan a semántica  CHAR en su lugar (lo que es mejor para compatibilidad entre bases de datos y mayores contenidos  max. length).<br /><br /> Una vez generadas, usted puede copiar estas instrucciones y ejecutarlas de modo seguro en su interfase SQL faborita (no olvide respaldar sus datos ANTES de hacerlo).<br /><br /> Es muy recomendable estar ejecutando la versión Moodle más reciente  (+ version) disponible para su Moodle  (2.2, 2.3, 2.x ...)antes de ejecutar la búsqueda de semántica BYTE.<br /><br />. Esta funcionalidad no ejecuta ninguna acción contra la BD (simplemente lee en ella), de modo que puede ejecutarse con seguridad en cualquier momento.';
...
$string['yeswrongoraclesemanticsfound'] = 'Algunas columnas de Oracle que emplean semántica de BYTE han sido encontradas en su base de datos. Aquí están los detalles y las instrucciones SQL que es necesario  ejecutar con su interfase favorita de SQL para crearlas. ( no se olvide de hacer un respaldo ANTES).<br /><br />. Después de esto, es muy recomendable ejecutar esta utilería de nuevo para revisar que no se encuentran más semánticas equivocadas.';
