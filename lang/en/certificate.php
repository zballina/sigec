...
/**
 * Strings for component 'certificate', language 'es_mx', branch 'MOODLE_24_STABLE'
 *
 * @package   certificate
...
$string['reissuecert_help'] = 'Si elige \'Si\' aquí, entonces este certificado será re-emitido con una nueva fecha, calificación y número clave cada vez que el usuario elija el enlace para certificado. Observe que a pesar que una tabla mostyrará las fechas pasadas de recepción, no existirá botón disponible para que el usuario las vea. En el reporte del certificado solamente aparecerá el certificado más recientemente emitido.';
