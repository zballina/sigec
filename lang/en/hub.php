...
/**
 * Strings for component 'hub', language 'es_mx', branch 'MOODLE_25_STABLE'
 *
 * @package   hub
...
$string['advertise'] = 'Anunciar este curso para que la gente se inscriba';
...
$string['advertisepublication_help'] = 'La publicación de su curso en un servidor hub o Central de Cursos de la Comunidad permite a otras personas encontrar este curso y poderse inscribir.';
$string['all'] = 'Todo';
...
$string['errorlangnotrecognized'] = 'El código de idioma que ha proporcionado es desconocido por Moodle. Por favor, contacte a {$a}';
$string['errorregistration'] = 'Se produjo un error durante el registro, por favor, inténtelo de nuevo más tarde. ({$a})';
$string['errorunpublishcourses'] = 'Debido a un error inesperado, no se han podido eliminar los cursos en la Central de Cursos. Inténtelo de nuevo más tarde (recomendado) o póngase en contacto con el administrador de la central de cursos.';
$string['existingscreenshotnumber'] = '{$a} pantallazos existentes. Usted puede ver estos pantallazos en esta página, solamente después de que el administrador del hub habilite su curso.';
...
$string['geolocation_help'] = 'En el futuro podríamos proporcionar búsqueda basada en la localización. Si desea especificar la ubicación de su curso use un valor de posición latitud/longitud (por ejemplo: 19.1950,99.1035). Una forma de encontrar este valor es mediante Google Maps.';
...
$string['no'] = 'No';
$string['nocheckstatusfromunreghub'] = 'Este sitio no está registrado en el hub, por lo que el status no puede comprobarse';
...
$string['publisheremail_help'] = 'La dirección de correo electrónico del editor permite al administrador del hub alertar al editor sobre cualquier cambio en el status del curso publicado.';
...
$string['registeredon'] = 'Hub con quien está Usted registrado';
$string['registeredsites'] = 'Sitios registrados';
$string['registermoochtips'] = 'Para registrarse con Moodle.net, su sitio sitio debe estar registrado con Moodle.org.';
...
$string['registrationconfirmedon'] = 'Ya está registrada en el hub {$a}. Ahora ya puede publicar cursos en este hub mediante el enlace "Publicar" situado en el menú de administración del curso.';
...
$string['sitecountry_help'] = 'El país en donde se encuentra su organización';
$string['sitecreated'] = 'Sitio creado';
$string['sitedesc'] = 'Descripción';
$string['sitedesc_help'] = 'Esta descripción de su sitio Moodle se mostrará en la lista junto a otros sitios. Por favor, utilice sólo texto simple sin marcas html o cualquier otra codificación.';
$string['siteemail'] = 'Dirección de correo electrónico';
$string['siteemail_help'] = 'Debe proporcionar una dirección de correo electrónico para que el administrador pueda contactar con usted si es necesario. Esta información no será utilizada para ningún otro propósito. Se recomienda emplear una dirección de corrreo electrónico asociada a un cargo administrativo (por ejemplo: jefedecomputo@ejemplo.com) y no a una persona en especial';
$string['sitegeolocation'] = 'Geolocalización';
$string['sitegeolocation_help'] = 'En el futuro podríamos proporcionar búsqueda basada en la localización. Si desea especificar la ubicación de su curso use un valor de posición latitud/longitud (por ejemplo: 19.1950,99.1035). Una forma de encontrar este valor es mediante Google Maps.';
...
$string['siteregistrationcontact'] = 'Formato de contacto';
$string['siteregistrationcontact_help'] = 'Si usted lo permite, otras personas podrán contactar con usted a través de un formato desde el hub. La dirección de correo electrónico no se mostrará.';
$string['siteregistrationemail'] = 'Notificaciones por correo electrónico';
$string['siteregistrationemail_help'] = 'Si habilita esta opción, el administrador del hub podrá enviarle un correo electrónico para informarle de cuestiones importantes como pueden ser los temas de seguridad.';
...
$string['tags'] = 'Etiquetas (tags)';
$string['tags_help'] = 'Las etiquetas (tags) ayudan a clasificar mejor su curso y ayudan a encontrarlo. Por favor, use palabras sencillas y significativas separadas por una coma. Ejemplo: matemáticas, álgebra, geometría';
...
$string['unpublishalladvertisedcourses'] = 'Retirar todos los cursos que actualmente se anuncian en un hub';
$string['unpublishalluploadedcourses'] = 'Se retiraron todos los cursos que habían sido subidos a un hub.';
...
$string['urlalreadyregistered'] = 'Parece que su sitio ya estaba registrado en este hub, lo que significa que algo ha ido mal. Póngase en contacto con el administrador del hub para que reinicie su registro y usted pueda intentarlo de nuevo.';
