...
/**
 * Strings for component 'cachestore_mongodb', language 'es_mx', branch 'MOODLE_25_STABLE'
 *
...
$string['testserver_desc'] = 'Esta es la cadena de conexión para el servidor de prueba que Usted quiere usar.  Los servidores de prueba son enteramente opcionales, al especificar un servidor de prueba Usted puede correr pruebas de PHPunit para este almacén y puede correr las pruebas de desempeño (rendimiento).';
