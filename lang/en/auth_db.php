...
/**
 * Strings for component 'auth_db', language 'es_mx', branch 'MOODLE_25_STABLE'
 *
 * @package   auth_db
...
$string['auth_dbfielduser_key'] = 'Campo de nombredeusuario';
$string['auth_dbhost'] = 'La computadora que hospeda el servidor de la base de datos.';
$string['auth_dbhost_key'] = 'Host';
$string['auth_dbinsertuser'] = 'Insertado el usuario {$a->name} id {$a->id}';
$string['auth_dbinsertuserduplicate'] = 'Error al insertar al usuario {$a->username} - un usuario con el mismo nombredeusuario ya había sido creado por el plugin de \'{$a->auth}\'.';
...
$string['auth_dbpass'] = 'Contraseña correspondiente al nombredeusuario anterior';
...
$string['auth_dbuser'] = 'Nombredeusuario con acceso de lectura a la base de datos';
