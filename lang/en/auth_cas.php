...
/**
 * Strings for component 'auth_cas', language 'es_mx', branch 'MOODLE_25_STABLE'
 *
 * @package   auth_cas
...
$string['auth_casdescription'] = 'Este método utiliza un servidor CAS (Central Authentication Service) para autenticar a los usuarios en un entorno SSO (Single Sign On). Usted puede también usar una autenticación simple LDAP. Si el nombredeusuario y la contraseña son válidos de acuerdo con CAS, Moodle crea una entrada de nuevo usuario en su base de datos, tomando de LDAP los atributos del usuario si fuera preciso. En los siguientes ingresos sólo se comprueban el nombredeusuario y la contraseña.';
