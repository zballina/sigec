...
/**
 * Strings for component 'auth_mnet', language 'es_mx', branch 'MOODLE_25_STABLE'
 *
 * @package   auth_mnet
...
$string['auth_mnet_rpc_negotiation_timeout'] = 'El tiempo de expiración en segundos para autenticación a través de transporte XMLRPC.';
...
$string['sso_mnet_login_refused'] = 'Al nombredeusuario {$a->user} no le es permitido iniciar sesión desde {$a->host}.';
