...
/**
 * Strings for component 'editor_tinymce', language 'es_mx', branch 'MOODLE_25_STABLE'
 *
...
$string['advlink_dlg:popup_statusbar'] = 'Mostrar barra de status';
...
$string['customtoolbar_desc'] = 'Cada linea contiene una lista de nombres de botones separados por coma, use "|" como un separador de grupo, las líneas vacías se ignoran. Vea  <a href="{$a}" target="_blank">{$a}</a> para mostrar una lista de los botones estándar de TinyMCE.';
...
$string['fullscreen:desc'] = 'Cambiar modo Pantalla Completa';
...
$string['media_dlg:captioningid'] = 'ID de Subtítulos';
...
$string['media_dlg:imagestatus'] = 'Status de imágen';
...
$string['media_dlg:scriptcallbacks'] = 'Regresar llamada (callback) de Script';
...
$string['spellchecker:desc'] = 'Alternar corrector ortográfico';
...
$string['style_dlg:border'] = 'Orilla';
...
$string['style_dlg:box_float'] = 'Flotar';
...
$string['style_dlg:padding'] = 'Acolchonamiento';
...
$string['subplugindeleteconfirm'] = 'Usted está a punto de borrar completamente el subplugin TinyMCE \'{$a}\'. Esto borrará completamente de la base de datos todo lo relacionado con este subplugin. ¿Está SEGURO de querer continuar?';
