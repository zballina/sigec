...
/**
 * Strings for component 'scorm', language 'es_mx', branch 'MOODLE_25_STABLE'
 *
 * @package   scorm
...
$string['attemptstatusall'] = 'Mi hogar y página de entrada';
$string['attemptstatusentry'] = 'Página de entrada solamente';
$string['attemptstatusmy'] = 'Mi hogar solamente';
...
$string['badpackage'] = 'El paquete/manifiesto especificado no es válido. Compruébelo e inténtelo de nuevo.';
...
$string['completionstatusrequired'] = 'Requerir status';
$string['completionstatusrequired_help'] = 'All seleccionar uno o más status se le exigirá al usuario que logre al menos un status seleccionado para que pueda marcarse como finalizada esta actividad SCORM, al igual que cualquier otro requisito de Finalización de Actividad.';
$string['confirmloosetracks'] = 'ADVERTENCIA: El paquete parece haber sido cambiado o modificado.Si la estructura del paquete se ha cambiado,las pistas de algunos usuarios pueden haberse perdido durante el proceso de actualización.';
...
$string['displayattemptstatus'] = 'Mostrar status de intentos';
$string['displayattemptstatusdesc'] = 'Si es que se muestra un resumen de los intentos del usuario en el bloque de vista general del curso en la página de Mi hogar o en la página de entrada al SCORM.';
$string['displayattemptstatus_help'] = 'Esta preferencia permite un resumen de los intentos del usuario para mostrar la vista general del curso en Mi hogar y/o en la página de entrada al SCORM.';
...
$string['forcecompleted_help'] = 'Si se activa, el status del intento actual se cambia a "Finalizado". Este ajuste sólo se aplica a los paquetes SCORM 1.2.';
...
$string['forcenewattemptdesc'] = 'Si se habilita, cada vez que sea accesado un paquete SCORM se contará como un nuevo intento.';
...
$string['hidebrowsedesc'] = 'El modo de previsualización le permite a un estudiante ojear una actividad antes de intentarla.';
...
$string['hidenavdesc'] = 'Si se muestran o no los botones de navegación';
...
$string['interactionslatency'] = 'Tiempo transcurrido entre el momento en que la se puso a disposición del alumno la interacción para responder y el momento de la primera respuesta';
$string['interactionslearnerresponse'] = 'Respuesta del alumno';
$string['interactionspattern'] = 'Patrón de respuesta correcta';
$string['interactionsresponse'] = 'Respuesta del estudiante';
$string['interactionsresult'] = 'Resultado basado en la respuesta del estudiante y el resultado correcto';
...
$string['interactionsscoreraw'] = 'Número que refleja el desempeño del alumno en relación con el rango delimitado por los valores de mínimo y máximo';
...
$string['scorm:deleteownresponses'] = 'Borrar sus propios intentos';
...
$string['statusbar'] = 'Mostrar barra de status';
...
$string['trackingloose'] = 'ADVERTENCIA: ¡Los datos de rastreo de este paquete se perderán!';
$string['type'] = 'Tipo';
...
$string['whatgrade_help'] = 'Si se permiten múltiples intentos, esta configuración especifica si se almacenará en el libro de calificaciones el valor más alto, el promedio (la media), el primer intento o el último. La opción del último intento completado no incluye los intentos con status de \'fallido\' o \'reprobado\'
