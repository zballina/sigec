...
/**
 * Strings for component 'question', language 'es_mx', branch 'MOODLE_25_STABLE'
 *
 * @package   question
...
$string['changepublishstatuscat'] = '<a href="{$a->caturl}">La categoría "{$a->name}"</a> en curso "{$a->coursename}" cambiará su status de intercambio <strong>{$a->changefrom} a {$a->changeto}</strong>.';
...
$string['clickflag'] = 'Marcar con bandera la pregunta';
$string['clicktoflag'] = 'Señalar con bandera esta pregunta para referencias futuras';
$string['clicktounflag'] = 'Quitar bandera';
$string['clickunflag'] = 'Quitar bandera';
...
$string['errorsavingflags'] = 'Error al guardar el estado de la bandera.';
...
$string['notgraded'] = 'No calificadas';
...
$string['orphanedquestionscategoryinfo'] = 'Ocasionalmente, en forma típica debido a errores del software, las preguntas pueden quedarse en la base de datos a pesar de que la categoría de pregunta correspondiente haya sido eliminada. Por supuesto, esto no debería de pasar, pero ha sucedido en este sito en el pasado. Esta categoría ha sido creada automáticamente, y las preguntas huérfanas se han movido aquí para que Usted pueda manejarlas. Observe que cualquier imagen o archivo multimedia empleado por estas preguntas muy probablemente se ha perdido.';
...
$string['questionidmismatch'] = 'Des-coincidencia en los ids de preguntas';
...
$string['questionsinuse'] = '{*Las preguntas marcadas con un asterisco ya están en uso en algún examen. Estas preguntas no serán borradas de estos exámenes, solo de la lista de la categoría}';
...
$string['rightanswer_help'] = 'un resumen generado automáticamente de las respuestas correctas. Esto pudiese estar limitado, por lo que Usted podría desear explicar la solución correcta en la retroalimentación general para la pregunta, y deshabilitar esta opción.';
$string['save'] = 'Guardar';
$string['saved'] = 'Guardada: {$a}';
$string['saveflags'] = 'Guardar el estado de las banderas';
...
$string['submissionoutofsequence'] = 'Acceso fuera de secuencia. Por favor no haga click en el botón de regresar del navegador web cuando esté trabajando con las preguntas del examen';
$string['submissionoutofsequencefriendlymessage'] = 'Ha introducido datos fuera de la secuencia normal. Esto puede suceder si usa los botones de retroceder o avanzar del navegador web; por favor no los use durante un examen. También pudiera suceder si hace click sobre algo mientras se está cargando una página. Haga click en  <strong>Continuar</strong> para continuar.';
