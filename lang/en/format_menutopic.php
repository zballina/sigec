...
/**
 * Strings for component 'format_menutopic', language 'es_mx', branch 'MOODLE_24_STABLE'
 *
...
$string['config_editmenu_title'] = 'Configuraciones del menú';
...
$string['jsdefault_help'] = 'Define si es que las funciones JavaScript que generan el menú se incluyen. Desabilitar JavaScript por defecto puede ser útil si quiere darle otra apariencia al menú, empleando código JavaScript que puede incluirse en la  <b>"Plantilla Javascript"</b>.';
...
$string['templatetopic'] = 'Activar Título de Tema como plantilla';
$string['templatetopic_help'] = 'Acerca de: Activar Título de Tema como plantilla';
$string['title_panel_sheetedit'] = 'Editar hoja del árbol';
$string['topic_sheet_sheetedit'] = 'Tema destino';
