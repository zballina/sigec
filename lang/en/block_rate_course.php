...
/**
 * Strings for component 'block_rate_course', language 'es_mx', branch 'MOODLE_24_STABLE'
 *
...
$string['noguestuseage'] = 'Para valorar este curso necesita entrar.';
...
$string['survey'] = '¿Cúal es el nombre del cuestionario?';
$string['survey_help'] = 'Este es el módulo cuestionario al cual se ligará (dejar vacío para evitar que ligue a cuestionario)';
$string['viewreview'] = 'Ver respuestas del cuestionario';
