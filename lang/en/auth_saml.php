...
/**
 * Strings for component 'auth_saml', language 'es_mx', branch 'MOODLE_25_STABLE'
 *
 * @package   auth_saml
...
$string['auth_saml_courses_not_found'] = 'IdP regresó un conjunto de datos que no contienen el campo para mapeo de cursos SAML  ({$a}). Este campo se requiere para inscribir al usuario';
...
$string['auth_samldescription'] = 'Autenticación SSO empleando SimpleSAML';
...
$string['auth_saml_username_description'] = 'Atributo SAML que es mapeado a nombredeusuario Moodle - esto por defecto es eduPersonPrincipalName';
