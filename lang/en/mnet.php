...
/**
 * Strings for component 'mnet', language 'es_mx', branch 'MOODLE_25_STABLE'
 *
 * @package   mnet
...
$string['deletedhostinfo'] = 'El host ha sido borrado.Si quiere des-borrarlo, cambie el status de regreso a \'No\'.';
...
$string['mnetidproviderdesc'] = 'Usted puede emplear esta función para obtener un enlace con el que pueda entrar al sitio. Si puede proporcionar la dirección de correo electrónico correcta que coincida con el nombredeusuario con el cual Usted intentó entrar previamente.';
...
$string['mnetlog'] = 'Bitácoras (registros)';
...
$string['usernotfullysetup'] = 'Su cuenta de usuario está incompleta. Necesita ir <a href="{$a}">de regreso a su provedor</a> y asegurarse de que se complete su perfil allí. Puede que requiera salir del sitio y volver a entrar para que tenga efecto.';
