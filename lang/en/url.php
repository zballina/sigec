...
/**
 * Strings for component 'url', language 'es_mx', branch 'MOODLE_25_STABLE'
 *
 * @package   url
 ...
 * Nueva ventana - La URL se muestra en una nueva ventana delnavegador conmenús y una barra de dirección';
...
$string['popupwidth'] = 'Ancho de la ventana emergente (en pixels)';
