...
/**
 * Strings for component 'qtype_multichoice', language 'es_mx', branch 'MOODLE_25_STABLE'
 *
...
$string['fractionsnomax'] = 'Una de las respuestas debería valer el 100%, de modo que fuera <br />posible alcanzar la calificación total de esta pregunta.<br />¿Desea volver y arreglarlo?';
...
$string['pluginname_help'] = 'En respuesta a una pregunta (que puede incluir una imagen) el alumno elige la respuesta entre varias respuestas posibles. Hay dos tipos de preguntas con respuesta múltiple: con una y con más de una respuesta válida.';
