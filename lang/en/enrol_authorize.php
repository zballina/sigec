...
/**
 * Strings for component 'enrol_authorize', language 'es_mx', branch 'MOODLE_25_STABLE'
 *
...
$string['adminneworder'] = 'Estimado Administrador, Ha recibido una nueva orden pendiente: ID Orden: {$a->orderid} ID Transacción: {$a->transid} Usuario: {$a->user} Curso: {$a->course} Cantidad: {$a->amount} ¿HABILITADA CAPTURA PROGRAMADA?: {$a->acstatus} Si está habilitada la captura programada, la tarjeta de crédito será capturada en {$a->captureon} y el usuario podrá inscribirse en el curso; en caso contrario, expirará en on {$a->expireon} y no podrá ser capturada después de ese día. Asimismo, usted puede aceptar o rechazar el pago para inscribir al estudiante inmediatamente siguiendo este enlace: {$a->url}';
...
$string['anemailexpired'] = 'Notificación de caducidad';
...
$string['anemailexpiredteacher'] = 'Notificación de caducidad - Profesor';
...
$string['anlogin'] = 'Authorize.net: Nombre de usuario';
...
$string['antestmodedesc'] = 'Correr las transacciones en modo de prueba (no se transferirá dinero alguno)';
...
$string['captureyes'] = 'La tarjeta de crédito será capturada y el estudiante será inscrito en el curso. ¿Está seguro?';
$string['cccity'] = 'Ciudad';
$string['ccexpire'] = 'Fecha de expiración';
$string['ccexpired'] = 'La tarjeta de crédito ha caducado';
$string['ccinvalid'] = 'Número de tarjeta no válido';
$string['cclastfour'] = 'Cuatro últimos dígitos CC';
...
$string['choosemethod'] = 'Si conoce la clave de inscripción en el curso, escríbala;<br />en caso contrario, necesitará pagar para acceder al curso.';
...
$string['cutofftimedesc'] = 'Hora de corte de transacción. ¿ Cuando la última transacción sea recibida para liquidación ?';
...
$string['echeckfirslasttname'] = 'Propietario de la cuenta bancaria';
$string['echecksavings'] = 'Ahorros';
$string['enrolenddate'] = 'Fecha final';
$string['enrolenddaterror'] = 'La fecha de final de inscripción no puede ser anterior a la fecha de comienzo';
$string['enrolname'] = 'Puerto de paso (gateway) para pagos Authorize.net';
...
$string['httpsrequired'] = 'Lamentamos comunicarle que su solicitud no puede procesarse en este momento. La configuración de este sitio no se ha podido realizar correctamente. <br /><br /> Por favor, no escriba su número de tarjeta de crédito a menos que vea un candado amarillo en la parte inferior del navegador. Ello significa transferidos entre cliente y servidor son encriptados, con el fin de proteger la información durante la transacción entre dos computadoras y que el número de su tarjeta no puede ser capturado en internet.';
...
$string['pendingecheckemail'] = 'Estimado mánager, En este momento hay {$a->count} echeques pendientes y usted debe subir un archivo csv para inscribir a los usuarios. Haga clic en el enlace de abajo y lea el archivo de ayuda en la página: {$a->url}';
...
{$a->enrolurl}';
$string['pendingordersemailteacher'] = 'Estimado profesor, {$a->pending} transacciones por un costo de {$a->currency} {$a->sumcost} para el curso "{$a->course}" caducarán a menos que usted acepte el pago dentro de los próximos {$a->days} días. Usted tiene que aceptar o rechazar los pagos manualmente debido a que el administrador no tiene habilitada la captura programada. {$a->url}';
$string['pendingorderssubject'] = 'ADVERTENCIA: {$a->course}, {$a->pending} orden(es) expirarán en {$a->days} día(s).';
$string['pluginname'] = 'Autorizar';
$string['reason11'] = 'Se ha enviado una transacción duplicada';
$string['reason13'] = 'La ID para ingreso del proveedor no es válida o la cuenta está inactiva.';
$string['reason16'] = 'La transacción no se ha encontrado.';
$string['reason17'] = 'El proveedor no acepta este tipo de tarjeta de crédito.';
$string['reason245'] = 'Este tipo de eCheque no se admite cuando se usa el formato de pago hospedado en la puerta de pago.';
...
$string['status'] = 'Permitir la inscripción por  Autorize.net';
...
$string['unenrolstudent'] = '¿Dar de baja (des-inscribir) al estudiante?';
$string['uploadcsv'] = 'Suboir archivo CSV';
$string['usingccmethod'] = 'Inscribirse usando <a href="{$a->url}"><strong>Tarjeta de crédito</strong></a>
Ayuda';
$string['usingecheckmethod'] = 'Inscribirse usando <a href="{$a->url}"><strong>eCheque</strong></a>';
...
$string['welcometocoursesemail'] = 'Estimado {$a->name}, Gracias por enviar su pago. Usted está inscrito en los siguientes cursos: {$a->courses} Puede ver los detalles de su pago o editar su perfil: {$a->paymenturl} {$a->profileurl}';
