...
/**
 * Strings for component 'error', language 'es_mx', branch 'MOODLE_25_STABLE'
 *
 * @package   error
...
$string['cannotmarktopic'] = 'No se pudo marcar ese tópico para este curso';
...
$string['cannotsettheme'] = '¡No se puede establecer el tema gráfico!';
...
$string['duplicateusername'] = 'Nombredeusuario duplicado: registro pasado por alto';
...
$string['grouphasidnumber'] = 'El Grupo "{$a}" tiene un idnumber y este pdo haber sido creado automáticamente por un sistema externo. Usted no tiene permiso para remover este grupo.';
...
$string['invalidoutcome'] = 'ID de competencia incorrecto';
...
$string['invalidsesskey'] = 'La \'sesskey\' enviada es incorrecta, y el formato no ha sido aceptado';
...
$string['invalidusername'] = 'El nombredeusuario dado contiene caracteres inválidos';
...
$string['loginasnoenrol'] = 'No puede usar inscribirse o dar de baja cuando está en una sesión "Ingresar como" a un curso';
...
$string['maxareabytes'] = 'El archivo es mayor que el espacio restante en ésta área.';
$string['maxbytes'] = 'El archivo es mayor que el tamaño máximo permitido.';
...
$string['nocapabilitytousethisservice'] = 'El usuario no tiene el permiso necesario para usar este servicio';
...
$string['nologinas'] = 'No está autorizado a \'ingresar como\' ese usuario';
...
$string['sessiondiskfull'] = 'La partición de sesiones está llena. No es posible ingresar en este momento. <br /> <br /> Por favor notifique al administrador del servidor.';
...
$string['themenotinstall'] = '¡Este tema gráfico no está instalado!';
...
$string['unenrolerror'] = 'Se produjo un error al intentar dar de baja (des-inscribir) a esta persona';
...
$string['usernotdeletedmissing'] = 'Usuario no eliminado: no se encontró el nombredeusuario.';
...
$string['usernotrenamedexists'] = 'Usuario no renombrado: el nuevo nombredeusuario ya está en uso.';
$string['usernotrenamedmissing'] = 'Usuario no renombrado: no se ha podido encontrar el nombredeusuario anterior.';
