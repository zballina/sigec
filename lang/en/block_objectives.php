...
/**
 * Strings for component 'block_objectives', language 'es_mx', branch 'MOODLE_25_STABLE'
 *
...
$string['edittimetablesinst'] = 'Para cada espacio de horario, seleccione un grupo al cual mostrarle los objetivos (o \'Todos los grupos\' para mostrárselos a todos), y una hora de inicio y fin. Configure el grupo a \'Desabilitar\' para remover este espacio de horario.<br/>Si necesita más espacios para un día, llene todos los espacios disponibles y luego elija \'Guardar cambios\' y se añadirán 3 espacios extra.';
$string['fullscreen'] = 'Pantalla completa';
$string['group'] = 'Grupo';
$string['incomplete'] = 'Objetivo incompleto';
$string['introduction'] = 'Introducción';
$string['lesson'] = 'Lección para';
$string['lessonend'] = 'Fin';
$string['lessonendhour'] = 'Hora de término';
$string['lessonendminute'] = 'Minuto de término';
$string['lessonstart'] = 'Inicio';
$string['lessonstarthour'] = 'Hora de inicio';
$string['lessonstartminute'] = 'Minuto de inicio';
$string['nextweek'] = 'Siguiente semana';
...
$string['pluginname'] = 'Objetivos de lección';
$string['prevweek'] = 'Semana anterior';
$string['saveandcourse'] = 'Guardar y regresar al curso';
$string['saveandobjectives'] = 'Guardar y editar objetivos';
