...
/**
 * Strings for component 'qtype_ddmatch', language 'es_mx', branch 'MOODLE_25_STABLE'
 *
...
$string['pluginname_help'] = 'Preguntas de Relacionar Columnas mediante Arrastrar-y-Soltar requieren que el estudiante relacione correctamente una lista de nombres o de oraciones (preguntas) contra otra lista de nombres o de oraciones (respuestas).';
