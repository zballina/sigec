...
/**
 * Strings for component 'glossary', language 'es_mx', branch 'MOODLE_25_STABLE'
 *
 * @package   glossary
...
$string['cnfapprovalstatus'] = 'Define el status por defecto de las entradas colocadas por los estudiantes';
...
$string['modulename_help'] = 'El módulo glosario permite a los participantes crear y mantener una lista de definiciones, igual que un diccionario, o colectar y organizar recursos o información.

Un profesor puede permitir que se anexen archivos a las entradas del glosario. Las imágenes anexas se muestran en la entrada del glosario. Las entradas se pueden emplear en búsquedas, o se pueden ojear en órden alfabético o por categoría, fecha o autor. Las entradas pueden ser aprobadas por defecto o puede requerirse aprobación por un profesor antes de que sean visibles para todos.
