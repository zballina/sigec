...
/**
 * Strings for component 'block_community', language 'es_mx', branch 'MOODLE_25_STABLE'
 *
...
$string['add'] = 'Añadir';
$string['addcommunitycourse'] = 'Añadir curso comunitario';
...
$string['community:addinstance'] = 'Añadir un nuevo bloque de buscador de comunidad';
$string['community:myaddinstance'] = 'Añadir un nuevo bloque de buscador de comunidad a Mi Hogar';
...
$string['downloadconfirmed'] = 'La copia de respaldo se ha guardado en sus archivos privados {$a}';
...
$string['enroldownload_help'] = 'Algunos cursos listados en el centro seleccionado están publicitados para que la gente pueda entrar y participar en ellos en el sitio original.

Otros son plantillas de curso que se facilitan para que usted pueda descargarlas y usarlas en su propio sitio Moodle';
$string['enrollable'] = 'cursos en los que me puedo  inscribir';
$string['enrollablecourses'] = 'Cursos para inscribirse';
...
$string['hub'] = 'centro';
$string['hubnottrusted'] = 'No confiable';
...
$string['noratings'] = 'Sin valuaciones (ratings)';
...
$string['orderbyratingaverage'] = 'Valuación  (rating)';
