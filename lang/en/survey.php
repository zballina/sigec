...
/**
 * Strings for component 'survey', language 'es_mx', branch 'MOODLE_25_STABLE'
 *
 * @package   survey
...
$string['collesapintro'] = 'El propósito de este cuestionario es ayudarnos a entender hasta qué punto la presentación en línea de esta unidad le facilitó el aprendizaje. Cada una de las declaraciones siguientes le pedirán que compare su experiencia <strong>favorita</strong> (ideal) y su experiencia <strong>real</strong> en esta unidad. Sus respuestas serán tratadas con alto grado de confidencialidad y no afectarán su evaluación. Sus respuestas, pensadas cuidadosamente, nos ayudarán a mejorar la manera de presentar esta unidad en el futuro. Muchas gracias por su colaboración.';
