...
/**
 * Strings for component 'format_weeksrev', language 'es_mx', branch 'MOODLE_25_STABLE'
 *
...
$string['futureweek'] = 'Semana Futura (Oculta para los estudiantes)';
$string['futureweeks'] = 'Semanas Futuras (Ocultas para los estudiantes)';
