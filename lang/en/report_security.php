...
/**
 * Strings for component 'report_security', language 'es_mx', branch 'MOODLE_25_STABLE'
 *
...
$string['check_defaultuserrole_details'] = '<p>A todos los usuarios autenticados se les asignan los permisos del rol de usuario por defecto. Por favor, asegúrese de que no se admiten permisos de riego en este rol. </p> <p>Para el rol de usuario por defecto solo se permite heredar el tipo <em>usuario autenticado</em>. El permiso para ver el curso no debe estar habilitado. </p>';
...
$string['check_noauth_details'] = '<p>El plugin de  <em>No autenticación</em> no está diseñado para sitios en producción. Por favor deshabilítelo a menos que este sea un servidor de pruebas en desarrollo.</p>';
$string['check_noauth_error'] = 'El plugin de No-autenticación no puede emplearse en sitios de producción.';
$string['check_noauth_name'] = 'No autenticación';
$string['check_noauth_ok'] = 'No hay plugins de autenticación deshabilitados.';
$string['check_openprofiles_details'] = '<p>Los perfiles de usuario abiertos pueden ser explotados por spammers. Se recomienda que haga una de dos acciones: Habilitar <code>Forzar a los usuarios a que ingresen para que puedan ver perfiles</code> o  Habilitar <code>Forzar usuarios a ingresar.</p>';
