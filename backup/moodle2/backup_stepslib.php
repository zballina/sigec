...
class backup_section_structure_step extends backup_structure_step {
    ...
    protected function define_structure() {
        ...
        $unidades = new backup_nested_element('unidades', array('id'), array(
                'nu_unidad', 'nu_periodo', 'estado', 'observaciones', 'observacionesformat',
                'clave', 'nombre', 'satca', 'caracterizacion', 'caracterizacionformat', 'objetivocurso', 'objetivocursoformat',
                'competenciaespecifica', 'competenciaespecificaformat', 'competenciasgenericas', 'competenciasgenericasformat',
                'apoyosdidacticos', 'apoyosdidacticosformat', 'fuentesinformacion', 'fuentesinformacionformat',
                'fecha_elabora', 'fecha_revision', 'observaciones_revision', 'observaciones_revisionformat'));
        ...
        $unidades->set_source_table('course_unidades', array('id' => backup::VAR_SECTIONID));
        // Aliases
