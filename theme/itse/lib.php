...
function itse_process_css($css, $theme) {
    ...
    $css = itse_set_regionwidths($css, $regionprewidth, $regionpostwidth);
    ...
    $css = itse_set_customcss($css, $customcss);
...
function itse_set_regionwidths($css, $regionprewidth, $regionpostwidth) {
...
function itse_set_customcss($css, $customcss) {
