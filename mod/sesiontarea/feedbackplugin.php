...
require_once($CFG->dirroot.'/mod/sesiontarea/sesiontareamentplugin.php');

/**
 * Abstract class for feedback_plugin inherited from sesiontarea_plugin abstract class.
 *
 * @package   mod_sesiontarea
 * @copyright 2012 NetSpot {@link http://www.netspot.com.au}
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
abstract class sesiontarea_feedback_plugin extends sesiontarea_plugin {
     ...
     *
     * Only one feedback plugin can push comments to the gradebook and that is chosen by the sesiontareament
     * settings page.
     *
     ...
     *
     * A grading action is a page that is not specific to a user but to the whole sesiontareament.
     * @return array - An array of action and description strings.
