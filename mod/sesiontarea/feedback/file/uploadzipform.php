 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class sesiontareafeedback_file_upload_zip_form extends moodleform {
    /**
    ...
    public function definition() {
        ...
        $mform->addElement('header', 'uploadzip', get_string('uploadzip', 'sesiontareafeedback_file'));
        ...
        $mform->addHelpButton('feedbackzip', 'feedbackzip', 'sesiontareafeedback_file');
        ...
        $this->add_action_buttons(true, get_string('importfeedbackfiles', 'sesiontareafeedback_file'));
