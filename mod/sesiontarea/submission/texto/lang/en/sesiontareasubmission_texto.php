...
/**
 * Strings for component 'sesiontareasubmission_texto', language 'es_mx', branch 'MOODLE_25_STABLE'
 *
...
$string['allowtextosubmissions'] = 'Habilitado';
...
$string['nosubmission'] = 'No se ha enviado nada para esta practica';
$string['numwords'] = '({$a} palabras)';
$string['numwordsforlog'] = 'Conteo de palabras del envío: {$a} palabras';
$string['texto'] = 'Texto en Línea';
$string['textofilename'] = 'texto.html';
$string['textosubmission'] = 'Permitir envío de Texto en Línea';
$string['pluginname'] = 'Envío de Texto en Línea';
$string['sexo'] = 'Genero del estudiante';
