YUI.add('moodle-mod_sesiontarea-history', function (Y) {
    // Define a function that will run in the context of a
    // Node instance:
    var CSS = {
            LINK: 'mod-sesiontarea-history-link',
            OPEN: 'mod-sesiontarea-history-link-open',
            CLOSED: 'mod-sesiontarea-history-link-closed',
            PANEL: 'mod-sesiontarea-history-panel'
        },
        COUNT = 0,
        TOGGLE = function() {
            var id = this.get('for'),
