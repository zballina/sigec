@mod @mod_sesiontarea
Feature: Group sesiontareament submissions
  In order to allow students to work collaboratively on an sesiontareament
  As a teacher
  ...
  Scenario: Switch between group modes
    ...
    And I add a "Assignment" to section "1" and I fill the form with:
      ...
      | Description | Test sesiontareament description |
