@mod @mod_sesiontarea
Feature: Prevent or allow sesiontareament submission changes
  ...
  Scenario: Preventing changes and allowing them again
    ...
    And I should see "This sesiontareament is not accepting submissions"
    And I log out
    And I log in as "teacher1"
    And I follow "Course 1"
    And I follow "Test sesiontareament name"
    ...
    And I follow "Course 1"
    And I follow "Test sesiontareament name"
    And I should not see "This sesiontareament is not accepting submissions"
    And I press "Edit submission"
    And I fill the moodle form with:
