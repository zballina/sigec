@mod @mod_sesiontarea @_only_local
Feature: In an sesiontareament, students can upload files for assessment
  In order to complete my sesiontareaments providing files
  As a student
  ...
  Scenario: Submit a file and update the submission with another file
    ...
    And I add a "Assignment" to section "1" and I fill the form with:
      ...
      | sesiontareasubmission_onlinetext_enabled | 0 |
      | sesiontareasubmission_file_enabled | 1 |
