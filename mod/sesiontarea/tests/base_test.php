...
/**
 * Base class for unit tests for mod_sesiontarea.
 *
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class mod_sesiontarea_base_testcase extends advanced_testcase {
    ...
    /** @var stdClass $course New course created to hold the sesiontareaments */
    ...
    /**
     * Setup function - we will create a course and add an sesiontarea instance to it.
     */
    ...
    /**
     * Convenience function to create a testable instance of an sesiontareament.
     *
     * @param array $params Array of parameters to pass to the generator
     * @return testable_sesiontarea Testable wrapper around the sesiontarea class.
     */
    protected function create_instance($params=array()) {
        ...
        return new testable_sesiontarea($context, $cm, $this->course);
    }
 ...
 */
class testable_sesiontarea extends sesiontarea {
