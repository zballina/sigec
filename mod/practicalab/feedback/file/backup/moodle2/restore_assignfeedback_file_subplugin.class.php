 ...
 * to restore one practicalab_feedback subplugin.
 *
 * @package   practicalabfeedback_file
 * @copyright 2012 NetSpot {@link http://www.netspot.com.au}
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class restore_practicalabfeedback_file_subplugin extends restore_subplugin {

    /**
     * Returns the paths to be handled by the subplugin at practicalabment level
     * @return array
     */
     ...
     * @param mixed $data
     */
    public function process_practicalabfeedback_file_grade($data) {
        global $DB;
        ...
        $DB->insert_record('practicalabfeedback_file', $data);

        $this->add_related_files('practicalabfeedback_file', 'feedback_files', 'grade', null, $oldgradeid);
    }
