...
/**
 * Restore subplugin class that provides the necessary information needed to restore
 * one practicalabfeedback subplugin.
 *
 * @package   practicalabfeedback_comments
 * @copyright 2012 NetSpot {@link http://www.netspot.com.au}
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class restore_practicalabfeedback_comments_subplugin extends restore_subplugin {
     ...
     * @param mixed $data
     */
    public function process_practicalabfeedback_comments_grade($data) {
        global $DB;
        ...
        $DB->insert_record('practicalabfeedback_comments', $data);
    }
}
