...
require_once($CFG->dirroot.'/mod/practicalab/practicalabmentplugin.php');

/**
 * Abstract class for feedback_plugin inherited from practicalab_plugin abstract class.
 *
 * @package   mod_practicalab
 * @copyright 2012 NetSpot {@link http://www.netspot.com.au}
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
abstract class practicalab_feedback_plugin extends practicalab_plugin {
     ...
     *
     * A grading action is a page that is not specific to a user but to the whole practicalabment.
     * @return array - An array of action and description strings.
