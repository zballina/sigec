 ...
 * needed to restore one practicalab_submission subplugin.
 *
 * @package practicalabsubmission_file
 * @copyright 2012 NetSpot {@link http://www.netspot.com.au}
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class restore_practicalabsubmission_file_subplugin extends restore_subplugin {
     ...
     * @return void
     */
    public function process_practicalabsubmission_file_submission($data) {
        global $DB;
        ...
        $DB->insert_record('practicalabsubmission_file', $data);

        $this->add_related_files('practicalabsubmission_file',
                                 'submission_files',
                                 'submission',
                                 null,
                                 $oldsubmissionid);
