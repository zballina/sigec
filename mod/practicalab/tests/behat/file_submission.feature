@mod @mod_practicalab @_only_local
Feature: In an practicalabment, students can upload files for assessment
  In order to complete my practicalabments providing files
  As a student
  ...
  Scenario: Submit a file and update the submission with another file
    ...
    And I add a "Assignment" to section "1" and I fill the form with:
      ...
      | practicalabsubmission_texto_enabled | 0 |
      | practicalabsubmission_file_enabled | 1 |
