@mod @mod_practicalab
Feature: Group practicalabment submissions
  In order to allow students to work collaboratively on an practicalabment
  As a teacher
  ...
  Scenario: Switch between group modes
    ...
    And I add a "Assignment" to section "1" and I fill the form with:
      ...
      | Description | Test practicalabment description |
