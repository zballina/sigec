@mod @mod_practicalab
Feature: Prevent or allow practicalabment submission changes
  ...
  Scenario: Preventing changes and allowing them again
    ...
    And I add a "Assignment" to section "1" and I fill the form with:
      | Assignment name | Test practicalabment name |
      | Description | Submit your online text |
      | practicalabsubmission_texto_enabled | 1 |
      | practicalabsubmission_file_enabled | 0 |
    And I log out
    And I log in as "student1"
    And I follow "Course 1"
    And I follow "Test practicalabment name"
    ...
    And I should see "This practicalabment is not accepting submissions"
    And I log out
    And I log in as "teacher1"
    And I follow "Course 1"
    And I follow "Test practicalabment name"
    ...
    And I follow "Course 1"
    And I follow "Test practicalabment name"
    And I should not see "This practicalabment is not accepting submissions"
    And I press "Edit submission"
    And I fill the moodle form with:
