...
/**
 * Base class for unit tests for mod_practicalab.
 *
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class mod_practicalab_base_testcase extends advanced_testcase {
    ...
    /** @var stdClass $course New course created to hold the practicalabments */
    ...
    /**
     * Setup function - we will create a course and add an practicalab instance to it.
     */
    ...
    /**
     * Convenience function to create a testable instance of an practicalabment.
     *
     * @param array $params Array of parameters to pass to the generator
     * @return testable_practicalab Testable wrapper around the practicalab class.
     */
    protected function create_instance($params=array()) {
        ...
        return new testable_practicalab($context, $cm, $this->course);
    }
 ...
 */
class testable_practicalab extends practicalab {
