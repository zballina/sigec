YUI.add('moodle-mod_practicalab-history', function (Y) {
    // Define a function that will run in the context of a
    // Node instance:
    var CSS = {
            LINK: 'mod-practicalab-history-link',
            OPEN: 'mod-practicalab-history-link-open',
            CLOSED: 'mod-practicalab-history-link-closed',
            PANEL: 'mod-practicalab-history-panel'
        },
        COUNT = 0,
        TOGGLE = function() {
            var id = this.get('for'),
