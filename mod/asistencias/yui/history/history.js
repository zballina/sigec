YUI.add('moodle-mod_asistencias-history', function (Y) {
    // Define a function that will run in the context of a
    // Node instance:
    var CSS = {
            LINK: 'mod-asistencias-history-link',
            OPEN: 'mod-asistencias-history-link-open',
            CLOSED: 'mod-asistencias-history-link-closed',
            PANEL: 'mod-asistencias-history-panel'
        },
        COUNT = 0,
        TOGGLE = function() {
            var id = this.get('for'),
