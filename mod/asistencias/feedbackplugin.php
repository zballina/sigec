...
require_once($CFG->dirroot.'/mod/asistencias/asistenciasmentplugin.php');

/**
 * Abstract class for feedback_plugin inherited from asistencias_plugin abstract class.
 *
 * @package   mod_asistencias
 * @copyright 2012 NetSpot {@link http://www.netspot.com.au}
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
abstract class asistencias_feedback_plugin extends asistencias_plugin {
     ...
     *
     * Only one feedback plugin can push comments to the gradebook and that is chosen by the asistenciasment
     * settings page.
     *
     ...
     *
     * A grading action is a page that is not specific to a user but to the whole asistenciasment.
     * @return array - An array of action and description strings.
