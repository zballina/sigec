...
/**
 * Base class for unit tests for mod_asistencias.
 *
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class mod_asistencias_base_testcase extends advanced_testcase {
    ...
    /** @var stdClass $course New course created to hold the asistenciasments */
    ...
    /**
     * Setup function - we will create a course and add an asistencias instance to it.
     */
    ...
    /**
     * Convenience function to create a testable instance of an asistenciasment.
     *
     * @param array $params Array of parameters to pass to the generator
     * @return testable_asistencias Testable wrapper around the asistencias class.
     */
    protected function create_instance($params=array()) {
        ...
        return new testable_asistencias($context, $cm, $this->course);
    }
 ...
 */
class testable_asistencias extends asistencias {
