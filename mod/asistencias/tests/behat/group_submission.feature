@mod @mod_asistencias
Feature: Group asistenciasment submissions
  In order to allow students to work collaboratively on an asistenciasment
  As a teacher
  ...
  Scenario: Switch between group modes
    ...
    And I add a "Assignment" to section "1" and I fill the form with:
      ...
      | Description | Test asistenciasment description |
