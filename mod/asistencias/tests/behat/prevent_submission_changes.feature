@mod @mod_asistencias
Feature: Prevent or allow asistenciasment submission changes
  ...
  Scenario: Preventing changes and allowing them again
    ...
    And I add a "Assignment" to section "1" and I fill the form with:
      ...
      | asistenciassubmission_file_enabled | 0 |
    And I log out
    ...
    And I should see "This asistenciasment is not accepting submissions"
    And I log out
    And I log in as "teacher1"
    And I follow "Course 1"
    And I follow "Test asistenciasment name"
    ...
    And I follow "Course 1"
    And I follow "Test asistenciasment name"
    And I should not see "This asistenciasment is not accepting submissions"
    And I press "Edit submission"
    And I fill the moodle form with:
