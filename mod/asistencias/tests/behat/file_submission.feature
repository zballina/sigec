@mod @mod_asistencias @_only_local
Feature: In an asistenciasment, students can upload files for assessment
  In order to complete my asistenciasments providing files
  As a student
  ...
  Scenario: Submit a file and update the submission with another file
    ...
    And I add a "Assignment" to section "1" and I fill the form with:
      | Assignment name | Test asistenciasment name |
      | Description | Submit your online text |
      | asistenciassubmission_onlinetext_enabled | 0 |
      | asistenciassubmission_file_enabled | 1 |
      | Maximum number of uploaded files | 2 |
    And I log out
    And I log in as "student1"
    And I follow "Course 1"
    And I follow "Test asistenciasment name"
