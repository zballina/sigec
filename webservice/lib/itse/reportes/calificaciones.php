...
class reporte_calificaciones extends reporte_base
{
    ...
    public function __construct($id, $groupid, $nu_unidad)
    {
        ...
        $this->prefijoArchivo = 'Cal-Unidad_' . $nu_unidad;
    ...
    protected function caratula()
    {
        ...
        $fecha = $this->unidad->fecha_programada_unidad($this->groupid);
        $fecha_periodo = $this->unidad->fecha_programada_periodo($this->groupid);
    ...
    protected function desglose()
    {
        ...
        $sesiones = $this->unidad->get_sesiones($this->groupid, true);
