...
class reporte_cursos_estadisticas extends reporte_base
{
    ...
    public function __construct($carrera)
    {
        ...
        $this->normaISO = 'Informe de Uso de la Plataforma Educativa de Docentes<br>' . $nombre;
        $this->prefijoArchivo = 'InformeUsoDocentes-';
