...
class Unidad
{
    ...
    public function get_sesiones($groupid, $filtrar)
    {
        return $this->sesiones->get_sesiones($groupid, $filtrar);
    }
 ...
 */
    ...
    public function fecha_real_unidad($groupid)
    {
    ...
    public function fecha_programada_unidad($groupid)
    {
        $fecha = $this->fecha_programada_final($groupid);
        if($fecha !== false)
            return userdate($fecha, '%d/%m/%Y');
    ...
    public function fecha_programada_periodo($groupid)
    {
        $fecha_ini = $this->fecha_programada_inicial($groupid);
        $fecha_fin = $this->fecha_programada_final($groupid);
        if($fecha_ini !== false)
    ...
    public function fecha_real_periodo($groupid)
    {
