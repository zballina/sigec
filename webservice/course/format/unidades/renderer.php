...
class format_unidades_renderer extends format_section_renderer_base
{
    ...
    protected function section_header($section, $course, $onsectionpage, $sectionreturn = null)
    {
        ...
        $url = new moodle_url('/course/format/unidades/confirma.php', 
                                array('id' => $section->id,
                                    'unidad' => $unidad->get_unidad()->nu_unidad, 
                                    'sesskey' => sesskey()));
        ...
        {            
            if($unidad->nu_unidad == $value->sectionnum 
                    && Sesiones::modulo_valido($value->modname) == true)
            {
                $cantidad++;
            }
        }
        
        $encabezado = "<br/><h3>Actividades Unidad $unidad->nu_unidad</h3>"
                . "Cantidad de sesiones: $cantidad";
        $o .= $section->section != 0 ? $encabezado: '<br/><h3>Evaluación diagnóstica y Recursos</h3>';
