...
class course_edit_form extends moodleform {
    ...
    function definition() {
        ...
        $mform->addElement('static', 'periodo_str', get_string('periodo', 'format_unidades'), $periodos);
        $mform->setType('periodo_str', PARAM_TEXT);
    ...
    public function get_data()
    {
        ...
        if($data != null)
        {
            $record = $DB->get_record('course_periodos', array('actual' => 1, 'nu_carrera' => $this->_customdata['category']->id));
            $data->periodo = $record->id;
        }
        return $data;
    }    
}
