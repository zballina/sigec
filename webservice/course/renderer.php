...
class core_course_renderer extends plugin_renderer_base {
    ...
    public function course_section_cm($course, &$completioninfo, cm_info $mod, $sectionreturn, $displayoptions = array()) {
        ...
        //     eye icon.
        $unidad = new Unidad($course, $mod->section);
        ...
        if($course->format == 'unidades'){
            if ($this->page->user_is_editing() && ($unidad->estado == PLANEACION_REVISADA || $unidad->estado == PLANEACION_NOREALIZADA || $unidad->estado == PLANEACION_REALIZADA)) {
                $output .= course_get_cm_move($mod, $sectionreturn);
            }
        }
        else if($course->format != 'unidades' && $this->page->user_is_editing()){
            $output .= course_get_cm_move($mod, $sectionreturn);
        }
        ...
        if($course->format == 'unidades') {
            if ($this->page->user_is_editing() && ($unidad->estado == PLANEACION_REVISADA || $unidad->estado == PLANEACION_NOREALIZADA || $unidad->estado == PLANEACION_REALIZADA)) 
            {
                ...
                $modicons .= ' '. $this->course_section_cm_edit_actions($editactions);
